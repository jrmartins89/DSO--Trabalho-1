...
class ControladorAquisicao:
    ...
    def efetuar_aquisicao(self, usuario, jogo):
        try:
            usuario = self.__controlador.biblioteca.controlador_usario.listar_usuario_por_id(id)
            jogo = self.__controlador_biblioteca.controlador_jogo.listra_jogo_por_nome(nome)
        except Exception:
