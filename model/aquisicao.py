...
class Aquisicao:
  def __init__ (self, usuario: Usuario, jogo: Jogo, data_aquisicao:str, metodo_pagamento: str, preco_compra: float):
  ...
  @preco_compra.setter
  def data_aquisicao(self, preco_compra: str):
    if isinstance(preco_compra,str):
      self.__data_aquisicao = preco_compra
